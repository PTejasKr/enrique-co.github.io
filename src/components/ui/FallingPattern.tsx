...
import { cn } from '@/lib/utils'; // Keeping cn for potential class pass-through, though less critical now
...
export function FallingPattern({
    ...
    return (
        <div className={cn(className)} style={{ position: 'relative', height: '100%', width: '100%', padding: '4px', overflow: 'hidden' }}>
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <div
                className="absolute inset-0 z-1 dark:brightness-600 pointer-events-none" // Ensure pointer-events-none if overlay
                style={{
